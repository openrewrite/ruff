...
use crate::types::{
    ...
    SubclassOfType, Type, TypeAliasType, TypeContext, TypeGuardType, TypeIsType, TypeMapping,
                        ...
                        if !self.deferred_state.is_deferred() {
                            ...
                            let should_emit_error = dunder_fails
                                || matches!(
                                    ...
                                    (
                                        Type::ClassLiteral(class), Type::StringLiteral(_))
                                        | (Type::StringLiteral(_), Type::ClassLiteral(class)
                                    )
